...
<head>
    ...
    <title>تلاش کے نتائج - اردو بچوں کی کتابیں</title>
...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <form class="d-flex me-3" action="search.php" method="get">
                    <input class="form-control me-2" type="search" placeholder="کتاب تلاش کریں..." name="q" aria-label="Search" value="<?= htmlspecialchars($query) ?>">
    ...
    <div class="container my-5">
        <h1 class="text-center mb-4">تلاش کے نتائج: "<?= htmlspecialchars($query) ?>"</h1>
        
        <?php if (empty($books)): ?>
            <div class="alert alert-info text-center">
                کوئی نتائج نہیں ملے۔ براہ کرم دوبارہ کوشش کریں۔
            </div>
        <?php else: ?>
            <div class="row">
