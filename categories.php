...
<head>
    ...
    <title><?= htmlspecialchars($category['name']) ?> - اردو بچوں کی کتابیں</title>
...
<body>
                    ...
                    <li class="nav-item dropdown category-dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <?php foreach ($categories as $cat): ?>
                                <li><a class="dropdown-item" href="categories.php?id=<?= $cat['id'] ?>"><?= $cat['name'] ?></a></li>
                            <?php endforeach; ?>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <div class="container my-5">
        ...
        <p class="text-center mb-5"><?= htmlspecialchars($category['description']) ?></p>
