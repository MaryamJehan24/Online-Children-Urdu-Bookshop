...
$books = getAllBooks(12); // Get 12 books for homepage
...
<head>
    ...
    <title>اردو بچوں کی کتابیں - آن لائن بک شاپ</title>
    ...
    <style>
        ...
        .hero-banner {
            background: linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url('https://images.unsplash.com/photo-1589998059171-988d887df646');
...
<body>
    ...
    <div class="hero-banner">
        <div>
            <h1 class="display-4">اردو بچوں کی کتابیں</h1>
            <p class="lead">تعلیم اور تفریح کا بہترین ذریعہ</p>
        </div>
    </div>

    <!-- Main Content -->
    <div class="container">
        <h2 class="text-center mb-4">مشہور کتابیں</h2>
        ...
        <div class="text-center mt-4">
            <a href="books.php" class="btn btn-primary">تمام کتابیں دیکھیں</a>
        </div>
    </div>
